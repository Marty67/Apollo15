...
#	if current_scene == "zeus":
#		$Interface/start.show()	
		
	#if current_scene == "zeus"	and next_scene == "Poseidon":
		
	elif current_scene =="poseidon-cave3" or current_scene =="zeus-cave1":
...
func hide_ui():
	$Interface/pauseBtn.hide()
	$Interface/Interface.hide()
